import subprocess
import time
output = subprocess.run('adb shell dumpsys notification --noredact | findstr com.camerasideas.instashot', shell=True, stdout=subprocess.PIPE, stderr=subprocess.PIPE, universal_newlines=True)

# print()

app_package_name =  'com.camerasideas.instashot'
