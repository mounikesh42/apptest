import subprocess
import time
output = subprocess.run('adb shell dumpsys notification --noredact | findstr com.estrongs.android.pop', shell=True, stdout=subprocess.PIPE, stderr=subprocess.PIPE, universal_newlines=True)

# print()

app_package_name =  'com.estrongs.android.pop'
